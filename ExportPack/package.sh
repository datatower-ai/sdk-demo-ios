...
EXPORTOPTIONSPLIST_PATH=./ExportOptions.plist
...
## workspace形式
xcodebuild archive -workspace ${WORKSPACE_PATH} -scheme ${SCHEME_NAME} -archivePath ${ARCHIVE_PATH} -destination 'generic/platform=iOS' -quiet || exit

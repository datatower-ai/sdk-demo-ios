...
//
//        DTAnalytics.userSet(properties: userSetProperties)
//
//        showProperties(properties: userSetProperties)
    }
...
//        DTAnalytics.userSetOnce(properties: userSetOnceProperties)
...
//        DTAnalytics.userAdd(properties: userAddProperties)
//        showProperties(properties: userAddProperties)
    }
    
    
    @IBAction func userUnset(_ sender: Any) {
//        DTAnalytics.userUnset(_properties: "user_password")
...
//        DTAnalytics.userAppend(properties: userAppendProperties)
